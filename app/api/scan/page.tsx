...
export default function PricingPage() {
  ...
  const handleCheckout = async (plan: string) => {
    setLoading(true);
    const email = typeof window !== "undefined" ? localStorage.getItem("ca_email") : undefined;
    ...
    <div className="min-h-screen bg-[#0a0f18] text-white px-6 py-20">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {tiers.map((t) => (
          <div
            key={t.name}
            className="border border-gray-800 bg-[#111827] rounded-2xl p-8 flex flex-col justify-between shadow-lg"
          >
            <div>
